...
Download `'factory'` of our [Unity environment models](https://drive.google.com/drive/folders/1bN4Fe-mmnHQnD1PCXhwYNwr7sZV_DgvO?usp=sharing) and unzip the files to the `'src/vehicle_simulator/mesh'` folder. 
